...
<ul class="nav navbar-nav navbar-right">
 ...
 <div style=" background: url(images/b.jpg)no-repeat; background-position:bottom;background-size: cover;height: 350px;">
     <div class="container text-center"><br><br>
         <h1 style="color: #FFFFCC;font-weight: 500;text-transform: capitalize;padding-top: 15%;
            font-size: 46px;line-height: 0px;">Photo Gallery</h1>
     </div>
 </div>
...
<div id="teachers" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <p style="font-size: 30px;">-Opening Ceremony Albums- </p>
            </div><!-- end title -->
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="our-team">
                        <div class="team-img">
                            ...
                            <div class="social">
                                <button style="cursor: pointer; margin-top: 70px;" class="btn btn-warning btn-outline-dark">More Images</button>
                            </div>
                        </div>
                    </div>
                </div>
