...
$c_month = date('m');
$c_date = date('m-d');
// $c_month = date('m', strtotime("january"));
// $c_date = date('m-d', strtotime("january 21"));
...
//    echo "<script>alert('q2-0')</script>";
        ...
        $amount_payable = $qta+$wc+$arreares+$awc;        
} 
...
//        echo "<script>alert('july,Aug,Sep')</script>";
        $wc = $qta*$wc_presentage;
        $amount_payable = $qta+$wc+$arreares+$awc; 
} 
...
//    echo "<script>alert('q4-0')</script>";
        ...
        if ($c_date==date("m-d",strtotime("December 31"))) {
//            echo "<script>alert('last date of Q4')</script>";
            $year_arreares = $qta*3;
        }
...
<div class="message-box">
    <a href="card_details_quater.php?cusid=<?php echo $id;?>&qtype=<?php echo $Q_T;?>&ya=<?php echo $year_arreares;?>&ap=<?php echo $amount_payable;?>&discount=<?php echo $discount;?>&wc=<?php echo $wc;?>&arreares=<?php echo $arreares;?>&awc=<?php echo $awc;?>&pq=<?php echo $paid_quaters;?>" class="hover-btn-new orange">
