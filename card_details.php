...
if (isset($_GET['cusid']) & isset($_GET['ap']) & isset($_GET['discount']) & isset($_GET['wc']) 
    & isset($_GET['arreares']) & isset($_GET['awc']) & isset($_GET['pq'])) {
...
<body class="host_version"> 
 ...
 <?php include 'pay_receipt.php'; ?>
     ...
     <div id="overviews" class="section lb">
        <div class="container">
            <!-- <div class="section-title row text-center"> -->
                ...
                <div class="row">
                    <div class="col-md-6  offset-md-3">
                        <form action="card_details.php" method="post" role="form">
    ...
    <div class="message-box">
        <button type="submit" name="paytax" class="btn social btn-warning btn-flat m-b-30 m-t-30">Pay Tax Amount</button>                   
    </div>
...
if ($runQPD) {
//   echo "<script>alert('Added Paid Quaters!')</script>";
}

$insertPay = "insert into payment(payment_method,card_number,card_holder_name,CSV_number,expire_date,paid_date,pay_status,year,cus_id,arreares,awc,warrant_cost,discount) values('$p_method', '$c_number', '$name', '$csv_number', '$exp_date', '$c_date','1','$c_year','$id','$arr','$awc', '$wc','$dis')";
...
$insertPR = "insert into payment_receipt(date, cus_id, premises_id, arreares, warrant_cost, rates, amount_paid,discount, print_desc,status,payment_id) values('$c_date', '$id', '$assno', '$arr', '$total_wc','$t_tax','$ap','$dis','1','1','$pay_id')";
$runPR = mysqli_query($con, $insertPR);

if ($runPR) {
//echo "<script>alert('Add data to payment receipt table')</script>";

$update_tv = "update tax_valuation set arreares = '0' where cus_id='$id'";
